							...
							<div className="bui_plr_12 bui_pt_24" style={user_head}>
								<div className="bui_media bui_p_12 bui_pt_72">
									...
									<div className="bui_media_b">
										<p className="bui_ts_18 bui_tc_white">邢鹏超  <span className="bui_ts_16 bui_pl_12"><i className="fa fa-bookmark-o"></i> 普通会员</span></p>
									...
									<div className="bui_media bui_p_12 bui_bgc_white">
										<div className="bui_media_l">
											...
											<Link to="/my/userCenter" className="bui_round bui_block"   style={{width:"48px",height:"48px"}}>
												<img src="../images/people.jpg" style={{width:"48px",height:"48px"}}	/>
											</Link>
										</div>
										
										<div className="bui_media_b">
											<p className="bui_ts_16 bui_tc_black">邢鹏超 <span className="bui_pl_12 bui_ts_10">1分钟前</span></p>
											...
											<div className="bui_avg_sm_3">
												<div>
													<p className="picList" >
														<img src="../images/girl.jpg" style={{width:"100%",height:"auto"}} />
													</p>
												</div>
												<div>
													<p className="picList" >
												...
												<div>
													<p className="picList" >
														<img src="../images/boy.jpg" style={{width:"100%",height:"auto"}} />
													</p>
												</div>
											</div>
											{/**<!--评论列表-->**/}
											<div className="commentList">
												...
												<div className="bui_bgc_gray bui_ts_12 bui_pb_6 bui_radius">
													<p className="bui_tc_gray bui_plr_6 bui_pt_6"><span className="bui_tc_pink">小丸子：</span>我家超哥好厉害，赞一个</p>
													<p className="bui_tc_gray bui_plr_6 bui_pt_6"><span className="bui_tc_pink">小丸子：</span>我家超哥好厉害，赞一个</p>
													<p className="bui_tc_gray bui_plr_6 bui_pt_6"><span className="bui_tc_pink">小丸子：</span>我家超哥好厉害，赞一个</p>
												</div>
											</div>
